...
//   var x = d3.scaleBand().domain(d3.range(numcols)).range([0, width]);

//   var y = d3.scaleBand().domain(d3.range(numrows)).range([0, height]);
...
//   var y = d3.scaleLinear().range([height, 0]).domain([minValue, maxValue]);
